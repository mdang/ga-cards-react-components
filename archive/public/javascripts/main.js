...
let GACardsApp = React.createClass({displayName: "GACardsApp",
  getInitialState: function() {
    return {
  ...
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement(Header, {title: "Cards Against Assembly", onChangeCallback:  this.changeSection}), 
        React.createElement(Section, {component:  this.state.component}), 
        React.createElement(Footer, {madeWith: "♥︎"})
      )
    )
  }
});

let Section = React.createClass({displayName: "Section",
  render: function() {
    return (
...
let Card = React.createClass({displayName: "Card",
  getInitialState: function() {
    return {
      visibility: 'hidden'
    }
  ...
  render: function() {
    return (
      React.createElement("div", {className: "col-sm-6 col-md-6 col-lg-4"}, 
        React.createElement("div", {className: "card", onClick:  this.cardClicked}, 
          React.createElement("h4", {id:  this.props.id, className:  'card-title ' + this.state.visibility},  this.props.question), 
          React.createElement("h6", null, "Cards Against Assembly")
        )
      )
    )
  }
...
let CardsSection = React.createClass({displayName: "CardsSection",
  getInitialState: function() {
    return {
      cards: []
    }
  ...
  render: function() {
    var cards = this.state.cards.map(card => 
      React.createElement(Card, {key:  card._id, id:  card._id, question:  card.question})
    );

    return (
      React.createElement("section", {id: "cards", className: "container-fluid"}, 
...
let NewSection = React.createClass({displayName: "NewSection",
  getInitialState: function() {
    return {
      newQuestion: ''
    }
  ...
  render: function() {
    return (
      React.createElement("section", {className: "container-fluid"}, 
        React.createElement("div", {className: "row"}, 
          React.createElement("form", {name: "add-card", id: "add-card", onSubmit:  this.submit}, 
            React.createElement("input", {ref: "newQuestionText", value:  this.state.newQuestion, onChange:  this.newQuestionChanged, type: "text", name: "question", id: "question", placeholder: "What's your question?"})
          ), 
          React.createElement("br", null), 
          React.createElement("div", {className: "card"}, 
            React.createElement("h4", {className: "card-title"},  this.state.newQuestion), 
            React.createElement("h6", null, "Cards Against Assembly")
          )
        )
      )
...
let AboutSection = React.createClass({displayName: "AboutSection",
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement("p", null, "To start the game, each player draws ten White Cards."), 
        React.createElement("p", null, "The person who most recently pooped begins as the Card Czar and plays a Black Card. The Card Czar reads the question or fill-in-the-blank phrase on the Black Card out loud."), 
        React.createElement("p", null, "Everyone else answers the question or fills in the blank by passing one White Card, face down, to the Card Czar."), 
        ...
        React.createElement("p", null, "After the round, a new player becomes the Card Czar, and everyone draws back up to ten White Cards.")
      )
    )
  }
});
    ...
    return (
      React.createElement("div", null, 
        React.createElement("header", {className: "navbar"}, 
          React.createElement("h1", {className: "pull-left"},  this.props.title)
        ), 

        React.createElement("nav", {className: "tabs"}, 
          React.createElement("a", {className:  (this.state.activeTab === 'home') ? 'active' : '', onClick:  this.tabClicked.bind(this, 'home') }, "Home"), 
          React.createElement("a", {className:  (this.state.activeTab === 'new') ? 'active' : '', onClick:  this.tabClicked.bind(this, 'new') }, "Add a New Card"), 
          React.createElement("a", {className:  (this.state.activeTab === 'about') ? 'active' : '', onClick:  this.tabClicked.bind(this, 'about') }, "About")
        )
      )
    )
  }
  ...
  render: function() {
    return (
      React.createElement("footer", null, 
        React.createElement("p", null, "Made with ", React.createElement("span", {className: "heart"},  this.props.madeWith), " at General Assembly")
      )
    )
  }
});

ReactDOM.render(React.createElement(GACardsApp, null), document.getElementsByClassName('container')[0]);
